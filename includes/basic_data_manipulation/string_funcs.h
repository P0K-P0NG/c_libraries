 ...
 * @param max_len       string max length
 * @param front_len     front buffer length
 * @param back_len      back buffer length
 * @param buffer_char   buffer character  
 * 
 * @return Pointer to the formatted string, NULL if was NULL passed in.
 */
char* str_add_buffer(char str[], size_t max_len, int front_len, int back_len, char buffer_char);
