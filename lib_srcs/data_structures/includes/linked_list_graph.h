...
typedef struct DLListNode LListGraphNode;
typedef struct DLList LListGraph;

/**
 * @brief
 *  Creates a new linked list graph.
 *
 * @return Pointer to the new linked list graph. NULL if memory allocation
 * failed.
 */
 ...
 */
extern int LListGraphRemove(LListGraph *graph, LListGraphNode *vertex_node,
                            void (*free_data)(void *));
 ...
 */
extern int LListGraphConnect(struct GraphVert *start, struct GraphVert *end);
 ...
 *  0 : no edge found @n
 */
extern int LListGraphDisconnect(struct GraphVert *start, struct GraphVert *end);
 ...
 * doesn't. @n Compare function input No. : @n 1) data from the doubly linked
 * list @n 2) key @n
 *
 ...
 */
extern LListGraphNode *LListGraphFindNode(LListGraph *graph, const void *key,
 ...
 */
extern int LListGraphIsConnected(struct GraphVert *start,
                                 struct GraphVert *end);
 ...
 * @param func      function to execute
 */
extern void LListGraphTraverseAdj(struct GraphVert *vertex,
                                  void (*func)(void *));
 ...
 */
extern void LListGraphSetAdjState(struct GraphVert *vertex,
                                  unsigned char state);
 ...
 *  0 : memory allocation failed @n
 */
extern int LListGraphBreathTraverse(struct GraphVert *vertex, int max_lvl,
                                    void (*func)(void *));
#endif